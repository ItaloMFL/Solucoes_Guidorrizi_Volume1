...
\begin{document}
	...
	\section*{7.4 Derivadas de $e^x$ e $\ln x$}
	\subsection*{7.4.1 Teorema: }
	
	\begin{flushleft}	
		São válidas as seguinte fórmulas de derivação
		
		\textbf{i. }  $y = e^x \Rightarrow y' = e^x$ \\ [1em]
		\textbf{ii. } $y = \ln x \Rightarrow y' = \frac{1}{x}, x > 0$ \\ [1em]	
	\end{flushleft}

	\subsection*{7.4.2 Notas de Aulas}

	\begin{flushleft}	
		Aqui vai as coisas que eu anotei enquanto fazia a aula ou estudava sozinho	
	\end{flushleft}

	\subsection*{7.4.3 Exercícios: }
	\begin{flushleft}	
